...
class AnimatedExpandableListView : ExpandableListView {
    ...
    abstract class AnimatedExpandableListAdapter : BaseExpandableListAdapter() {
        ...
        private fun setParent(parent: AnimatedExpandableListView) {
            this.parent = parent
        }
        ...
        private fun startExpandAnimation(groupPosition: Int, firstChildPosition: Int) {
            val info = getGroupInfo(groupPosition)
            info.animating = true
        ...
        private fun startCollapseAnimation(groupPosition: Int, firstChildPosition: Int) {
            val info = getGroupInfo(groupPosition)
            info.animating = true
            info.firstChildPosition = firstChildPosition
        ...
        override fun getChildView(groupPosition: Int, childPosition: Int, isLastChild: Boolean, convertView: View, parent: ViewGroup): View {
            ...
            if (info.animating) {
                ...
                val o: Any
                val state = if ((o = dummyView.tag) == null) STATE_IDLE else o as Int
    ...
    private class ExpandAnimation private constructor(private val view: View, private val baseHeight: Int, endHeight: Int, private val groupInfo: GroupInfo) : Animation() {
     ...
     */
        ...
        private val TAG = AnimatedExpandableListAdapter::class.java!!.getSimpleName()
