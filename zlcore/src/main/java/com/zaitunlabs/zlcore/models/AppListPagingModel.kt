...
class AppListPagingModel : Model, Serializable {
    ...
    fun withCountperpage(countperpage: Int): AppListPagingModel {
        this.countperpage = countperpage
        return this
    }

    fun withPrev(prev: Int): AppListPagingModel {
        this.prev = prev
        return this
    }

    fun withNext(next: Int): AppListPagingModel {
        this.next = next
        return this
    }
