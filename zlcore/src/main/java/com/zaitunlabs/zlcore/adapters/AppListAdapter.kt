...
class AppListAdapter(private val appList: List<AppListDataModel>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private inner class AppListViewHolder private constructor(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        if (viewType == VIEW_ITEM) {
            val rootView = LayoutInflater.from(parent.context).inflate(R.layout.app_list_item_row, parent, false)
            return AppListViewHolder(rootView)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (position < appList.size) {
            ...
            (holder as AppListViewHolder).titleView.text = appListDataModel.title
